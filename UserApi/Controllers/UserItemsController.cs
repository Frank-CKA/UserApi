...
namespace UserApi.Controllers
{
    ...
    public class UserItemsController : ControllerBase
    {
        ...
        // GET: api/UserItems
        [HttpGet]
        public async Task<ActionResult<IEnumerable<UserItem>>> GetTodoItems()
        {
        ...
        public async Task<ActionResult<UserItem>> GetUserItem(int id)
        {
          if (_context.TodoItems == null)
          {
            ...
            var userItem = await _context.TodoItems.FindAsync(id);
        ...
        public async Task<ActionResult<UserItem>> PostUserItem(UserItem userItem)
        {
          if (_context.TodoItems == null)
          {
            ...
            _context.TodoItems.Add(userItem);
            await _context.SaveChangesAsync();
        ...
        public async Task<IActionResult> DeleteUserItem(int id)
        {
            ...
            _context.TodoItems.Remove(userItem);
            await _context.SaveChangesAsync();
